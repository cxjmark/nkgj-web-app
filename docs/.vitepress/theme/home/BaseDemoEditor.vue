<template>
  <div id="demo-editor tw-px-3 " class="" ref="domRef">
    <div class="terminal">
      <slot />
      <div>
    ...
    if (block.value)
      ...
      new TypeIt(block.value, {
        ...
        startDelay: 900,
          ...
          .type('<br><h1 style="opacity: 0.5;">Welcome use @nk/hooks</h1><br /><br />', {
            delay: 100,
          })
          .type(
          ...
          .type(
              '&nbsp<span class="import-code">import</span> { <span class="module-code">useRequest</span> } from "<span class="export-code">@nk/hooks</span>" <br /> <br />',
              {
                delay: 100,
              },
          )
